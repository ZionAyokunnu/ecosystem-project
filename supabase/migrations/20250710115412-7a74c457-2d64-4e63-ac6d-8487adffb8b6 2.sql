-- Add phone number and demographics to profiles
ALTER TABLE public.profiles 
ADD COLUMN phone_number TEXT,
ADD COLUMN gender TEXT CHECK (gender IN ('Male', 'Female', 'Other', 'Prefer not to say')),
ADD COLUMN age_group TEXT CHECK (age_group IN ('18-24', '25-34', '35-44', '45-54', '55-64', '65+'));

-- Add voice and approval fields to surveys
ALTER TABLE public.surveys 
ADD COLUMN is_voice_enabled BOOLEAN DEFAULT false,
ADD COLUMN demographic_filters JSONB DEFAULT '{"genders": [], "age_groups": []}',
ADD COLUMN justification TEXT,
ADD COLUMN estimated_duration_minutes INTEGER DEFAULT 5,
ADD COLUMN approved_by_rep UUID REFERENCES public.profiles(id),
...
CREATE TABLE public.survey_notifications (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    survey_id UUID REFERENCES public.surveys(survey_id) NOT NULL,
    user_id UUID REFERENCES public.profiles(id) NOT NULL,
